...
export const reviews = [
  {
    ...
    profession: "Student",
    comment:
      "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Magnam alias blanditiis nesciunt assumenda delectus, non cum laudantium, impedit laboriosam corporis nulla magni dolore!",
  },
  {
    name: "John Doe",
    avatar: "https://randomuser.me/api/portraits/women/19.jpg",
...
<div className="container my-24 mx-auto md:px-6">
  <section className="mb-32 text-center">
    <h2 className="mb-12 pb-4 text-center text-3xl font-bold">Reviews</h2>
